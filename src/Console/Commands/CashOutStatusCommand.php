...
class CashOutStatusCommand extends Command
{
    use FakesConstellationHttp;
    use LogsConstellationActivity;

    protected $signature = 'constellation:cash-out-status {requestId} {--fake}';

    protected $description = 'Check cash-out status by request ID';
    ...
    public function handle(): int
    {
        ...
        try {
            $result = GetCashOutByRequestId::run($requestId);
